...
public class BanmaerOrderTest {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        BanmaErpResponseDTO<JsonNode> orderListJsonNode = objectMapper.readValue(getOrderList, new TypeReference<BanmaErpResponseDTO<JsonNode>>() {
        });
        Object[] objects = orderListJsonNode.toDataList(BANMAERP_FIELD_ORDERS);
        List<OrderDTO> orderList=
                Arrays.stream(objects).map(o -> (OrderDTO)o)
                        .collect(Collectors.toList());
        System.out.println("getOrderList\t\t"+orderList.get(0).getMaster().getStoreID()+"\t"+orderList.get(0).getMaster().getPlatform());
        ...
        String simpleOrder = "{\n" +
                ...
                "    \"Message\": \"成功\"\n" +
                "}\n";
        BanmaErpResponseDTO<OrderDTO> banmaErpResponseDTO1 = objectMapper.readValue(simpleOrder,
                new TypeReference<BanmaErpResponseDTO<OrderDTO>>() {});
        System.out.println(banmaErpResponseDTO1.getData().getMaster().getOriginalOrderID());
