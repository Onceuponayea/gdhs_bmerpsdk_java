...
public class BanmaerpURL {
    ...
    public final static String banmaerp_categorylist_GET = "/v1/category?PageNumber=%d&PageSize=%d&SearchTimeStart=%s&SearchTimeEnd=%s";
    ...
    public final static String banmaerp_accountlist_GET = "v1/Account";
