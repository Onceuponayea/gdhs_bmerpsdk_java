...
public class ProductSerialiser {
    ...
    public static class ProductSkuSerializer extends JsonSerializer<ProductSkusDTO> {
        @Override
        public void serialize(ProductSkusDTO value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
            JsonNode jsonNode =objectMapper.convertValue(value, JsonNode.class);
            String result = jsonNode!=null? jsonNode.toPrettyString() : "";
            gen.writeString(result);
        }
