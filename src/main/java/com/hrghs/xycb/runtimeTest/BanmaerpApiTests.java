...
//        addProduct();
    ...
    private void getStoreList() {
        List<StoreDTO> storeList = storeService.getStoretList(null, null, null, 1,
                100, "2022-01-01", "2022-01-01", null,
                null, null, null);
    ...
    private void getStoreById() {
        ...
        if (storeDTO != null) {
            ...
            System.out.println("find storeID:"+storeRepository.getReferenceById(storeDTO.getID()).getID());;
        }
    }
    ...
    private void getAccountList() {
        ...
        if (accountDTOList.size() > 0) {
            accountDTOList.forEach(accountDTO -> System.out.println(accountDTO.getRealName()));
            accountService.saveAccountList(accountDTOList);
            accountRepository.findAll().forEach(accountDTO -> System.out.println("fina-all ID:"+accountDTO.getID()));
        }
    }
    ...
    private void getAccountById() {
        ...
        if (accountDTO != null) {
            ...
            System.out.println("find accountID:"+accountRepository.getReferenceById(accountDTO.getID()).getID());;
        }
    }
    ...
    private void addAccount() {
        BanmaErpResponseDTO<Boolean> banmaErpResponseDTO = accountService.addAccount(
                "13799812120", "1052712355@qq.com", "蒋志鑫",
                "采购部", false, null);
    ...
    private void getCategoryList() {
        ...
        if (categoryDTOList.size() > 0) {
            ...
            categoryService.saveCategoryList(categoryDTOList);
            categoryRepository.findAll().forEach(categoryDTO -> System.out.println("fina-all ID:"+categoryDTO.getID()));
        }
    }
    ...
    private void getCategoryById() {
        ...
        if (categoryDTO != null) {
            ...
            System.out.println("find categoryID:"+categoryRepository.getReferenceById(categoryDTO.getID()).getID());
        }
    }
    ...
    private void saveAccountList() throws JsonProcessingException {
        ...
        accountService.saveAccountList(accountDTOS);
        accountRepository.findAll().forEach(accountDTO -> System.out.println("findAll- ID:\t " + accountDTO.getID()));
    }
